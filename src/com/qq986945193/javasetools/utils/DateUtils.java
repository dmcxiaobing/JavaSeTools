...
public class DateUtils {
	...
	public static String getIntervalStrDate(String specifiedStrDate, String dateForamtType, int intervalNum,
			int calenderParam) throws ParseException {
		...
		cal.setTime(DateUtils.turnStrDateToJavaUtilDate(specifiedStrDate, dateForamtType));
	 ...
	 */
	public static java.sql.Date turnStrDateToJavaSqlDate(String strDate, String dateFormateType) throws ParseException {
	 ...
	 */
	public static boolean isTwoStrDateTheSameDay(String strDate, String anotherStrDate) throws ParseException {
	 ...
	 * @return true/false
	 */
	public static boolean isTheLastDayOfCurrentMonth(Object targetObj, String formtStr) throws ParseException {
		...
		if (targetObj.getClass() == String.class) {
			srcDate = DateUtils.turnJavaUtilDateToStrDate(
					DateUtils.turnStrDateToJavaUtilDate(targetObj.toString(), "yyyy-MM-dd"), formtStr);
		} else if (targetObj.getClass() == Date.class) {
			srcDate = DateUtils.turnJavaUtilDateToStrDate((Date) targetObj, formtStr);
		} else {
			srcDate = DateUtils.turnJavaUtilDateToStrDate(new Date(), "yyyy-MM-dd");
		}
